...
When OpenAI or xAI media generation returns image payloads, the bot writes temporary artifacts locally and uploads them to Matrix. Grok Imagine video outputs are also downloaded to temporary local artifacts before upload.
